...
export default function Card({ adviceData, isLoading, handleClick }) {
  ...
  return (
    <MediaContextProvider>
      <div className="md:w-[34rem] w-full md:px-12 md:shadow-2xl shadow-xl max-w-[36rem]  flex flex-col justify-between px-[1.5rem] relative bg-dark-grayish-blue rounded-[1rem] text-center">
